...
const dropbolbill = ref(false)

function drophiderbill() {
   dropbolbill.value = !dropbolbill.value
}
...
<template>
   ...
   <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 bg-blue-600 border-r border-blue-400"
      :class="{ 'visible sm:visible': props.toside, 'invisible sm:visible': !props.toside }">

      <div class="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-b from-blue-600 to-cyan-500">
         <ul class="space-y-2 font-medium">
            <li>
               <router-link to="/Home" :class="fornav" @click="sideclicker">
                  <svg :class="foricon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                     viewBox="0 0 22 21">
                     <path
            ...
            <li>
              <a href="#" :class="fornav">
                 <svg :class="foricon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z"/>
                 </svg>
                 <span class="flex-1 ms-3 whitespace-nowrap">Inbox</span>
                 <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-white bg-green-500 rounded-full">3</span>
              </a>
           </li> -->
         ...
         ' text-white rounded-lg hover:bg-white hover:text-blue-600 group': !dropbolbill
                  ...
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Billing</span>
                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                     viewBox="0 0 10 6">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 4 4 4-4" />
