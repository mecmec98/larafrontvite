...
<div class = "p-4 sm:ml-64 mt-14 relative">
    ...
    <div v-show="modalviewer" @click="modaltoggle" class = "grid grid-cols-3 grid-span-6 bg-white absolute top-10 h-full w-5/6 ml-16 rounded-md shadow-md p-5 justify-items-center pt-5"> 
        <div>aa</div>
        <div>bb</div>
        <div>cc</div>
    </div>   
